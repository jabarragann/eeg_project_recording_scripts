    ...
    def run(self,):
        ...
        while self.controller.running:
            ...
            if k == 27:         # wait for ESC key to exit
                ...
                self.controller.controller_secondary_on = True
                ...
                self.controller.controller_secondary_on = False
...
class DummyController:
    def __init__(self):
        self.controller_secondary_on = True
        self.running = True

if __name__ == "__main__":
    timer = OpencvTimer(DummyController())
